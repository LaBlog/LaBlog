...
Route::group(['prefix' => $prefix], function() {
    ...
    Route::get('posts/{pagenumber?}', 'Lablog\Lablog\Controllers\PostController@showPosts');
    Route::get('category/{categories?}/{pagenumber}', 'Lablog\Lablog\Controllers\CategoryController@showCategory');
